...
#CLASS FOR CHOOSING BALL COLOUR
class color():
    def __init__(self):
...
#CLASS THAT CREATES THE FIRST GOLF COURSE
class course1():
        ...
        while run:
            ...
            if  shoot:
                ...
                if stop == False:
                    ...
                    self.ball.x = po[0] 
                    self.ball.y = po[1]
                    if (self.ball.x >236 and self.ball.x < 499):
                        top = True
                    elif(self.ball.x >=0 and self.ball.x <= 236):
                        top = False
                    ...
                    if self.ball.y > 210 and self.ball.x > 0:
                    ...
                    if (self.ball.x > 236 - self.ball.radius and self.ball.x < 499) and self.ball.y > 0 and flag == False:
                        if self.ball.y >= 210 - self.ball.radius:
                            self.ball.y = 2*(210 - self.ball.radius) - self.ball.y



#DRAWS THE LINE B/W THE BALL AND THE CURSOR.
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    pygame.quit()
                    quit()
#IF NEW SHOT IS TO BE MADE, THE PROGRAM LOOKS WHEN THE MOUSE IS PRESSED.
                if event.type == pygame.MOUSEBUTTONDOWN:
...
#CLASS THAT CREATES THE SECOND GOLF COURSE
class course2():
    def __init__(self,color):
        win = pygame.display.set_mode((500, 500))
        pygame.display.set_caption("First Game")
            ...
            if  shoot:
                ...
                if stop == False:
                    ...
                    if (self.ball.y > 151 and self.ball.y <= 499) and bottom2 == True:
                        if self.ball.x >= 355 and self.ball.x <= 358 + self.ball.radius:
...
#CLASS THAT CREATES THE FIRST TIME TRAIL COURSE
class course1_tt():
    def __init__(self,color):
        win = pygame.display.set_mode((500, 500))
        pygame.display.set_caption("First Game")
    ...
    def game_loop(self,surf,ball,ellapsed):
        ...
        while run:
            ...
            self.surf.blit(textSurf, textRect)
            seconds=(pygame.time.get_ticks()-start_ticks)/1000 #calculate how many seconds
            if seconds + self.ellapsed > 20: # if more than 20 seconds close the game
                #run = False
                shoot = False
                ...
                if stop == False:
                    ...
                    if self.ball.y > 210 and self.ball.x > 0:
                        if (self.ball.x >= 236 - self.ball.radius):
                            ...
                            flag = True
                    #IF BALL COLLIDES WITH THE TOP BOTTOM WALL
                    if (self.ball.x > 237 - self.ball.radius and self.ball.x < 499) and self.ball.y > 0 and flag == False:
                        if self.ball.y >= 210 - self.ball.radius:
                            self.ball.y = 2*(210 - self.ball.radius) - self.ball.y
...
#CLASS THAT CREATES THE SECOND TIME TRAIL COURSE
class course2_tt():
    def __init__(self,color):
        win = pygame.display.set_mode((500, 500))
        pygame.display.set_caption("First Game")
...
#SETS THE BALL'S TRAJECTORY
#inspired from http://archive.petercollingridge.co.uk/book/export/html/6
    @staticmethod
    ...
    def redrawWindow(self,surf,obj,line):
        ...
        pygame.display.update()
#FINDS THE ANGLE B/W MOUSE AND CURSOR
...
class TimeTrails():
    ...
    def levels(self):
        ...
        msg1 = pygame.font.Font("Kardust TS Condensed Bold Italic.ttf",20)
        textSurf, textRect = self.text_objects("Time Limit: 20 seconds", msg1)
        textRect.center = ( (485+(150/2)), (150+(30/2)) )
        self.win.blit(textSurf, textRect)
